...
export default function _Layout() {
  return <Tabs screenOptions={{
    ...
    <Tabs.Screen name="saved" options={{
      headerShown: false, title: "Saved", tabBarIcon: ({ focused }) => <TabIcon focused={focused} icon={icons.save} title="Saved" />
    }} />
    <Tabs.Screen name="profile" options={{
      headerShown: false, title: "Profile", tabBarIcon: ({ focused }) => <TabIcon focused={focused} icon={icons.person} title="Profile" />
    }} />
  </Tabs>;
}
